...
public class ApoliceService {
    ...
    public List<ApoliceDTO> buscarApolicesAVencer30Dias() {
        ...
        // Simulação de envio de notificação para as apólices a vencer
        apolicesAVencer.forEach(apolice -> {
            log.info("Simulação de mensageria: {} - {}", ROUTING_KEY_VENCIMENTO, 
    ...
    public ApoliceDTO salvar(ApoliceDTO apoliceDTO) {
        ...
        // Simulação de envio de notificação de nova apólice
        log.info("Simulação de mensageria: {} - {}", ROUTING_KEY_NOVA_APOLICE, 
